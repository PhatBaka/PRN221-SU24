...
namespace Services.Impls
{
	public class JewelryService : IJewelryService
	{
		...
		public double GetJewelrySalePrice(Jewelry jewelry)
		{
			...
			{
				_metalService.GetMetalSellPriceAndBuybackPriceByMetalName(metal.Material.MaterialName, out double BIDPRICE, out double OFFERPRICE);
                //totalMetalCost += (double)metal.Material.BidPrice * metal.JewelryWeight;
                totalMetalCost += (double) BIDPRICE * OFFERPRICE;
            }
